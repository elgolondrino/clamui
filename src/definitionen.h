...
#define APPS_TPL_PATH "/usr/share/" + QString(APP_NAME) + "/tpl/"
#define LANG_PATH "/usr/share/" + QString(APP_NAME) + "/translations/"
#define FLAGS_PATH "/usr/share/" + QString(APP_NAME) + "/flags/"
#define HELP_PATH "/usr/share/" + QString(APP_NAME) + "/doc/"
